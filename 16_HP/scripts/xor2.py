...
def run_leakage_simulation(pvt_row):
    ...
    .END
    """
    with open('../netlists/xor2_leakage.sp', 'w') as f:
        f.write(netlist)
    
    # subprocess.run(['ngspice', '-b', 'nand2_leakage.sp'])
    command = "ngspice -b ../netlists/xor2_leakage.sp > ../netlists/xor2_leakage.txt"
    ...
    with open('../netlists/xor2_leakage.txt', 'r') as f:
...
results.to_csv('../outputs/simulation_results_xor.csv', index=False)